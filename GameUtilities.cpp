...
pair<int, int> deduction() {
    // Let's assume the deductions are as follows:
    // Sunny: -15 hunger, -5 mental
    // Extreme Rainfall: -15 hunger, -5 mental
    // Extreme Cold: -20 hunger, -5 mental
    // Extreme Hot: -15 hunger, -10 mental
...
int check_health(const map<string, int>& bag) {
    int count = 0;
    if (bag.at("Hunger") < 20) {
